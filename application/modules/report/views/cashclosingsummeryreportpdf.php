...
?>
    <div style="" id="pdfprnt" style="width:330px; !important">
        <table align="center" style="width:330px; padding:0 5px;">
            <thead>
                <tr>
                    <th colspan="2" style="font-size: 21px; color: #000; padding-bottom: 5px; text-align: center; ">REPORTE DE CIERRE</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="font-size: 17px; color: #000; text-align: left;">APERTURA:</td>
                    <td style="font-size: 17px; color: #000; text-align: right;"><?php echo $startDate;?></td>
                </tr>
                <tr>
                    <td style="font-size: 17px; color: #000; text-align: left;">CIERRE :</td>
                ...
                <tr>
                    <td style="font-size: 17px; color: #000; text-align: left; border-bottom: 1px solid #000; border-bottom-style: dashed;">CAJERO :</td>
        ...
        <table align="center" style="width:330px; padding:0 5px;">
            <thead>
                <tr>
                    <th colspan="2" style="font-size: 21px; color: #000; padding-bottom: 5px; text-align: center;">RESUMEN DE VENTAS</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="font-size: 17px; color: #000; text-align: left; border-bottom: 1px solid #000; border-bottom-style: dashed;">PROPINAS :</td>
                ...
                <tr>
                    <td colspan="2" style="font-size: 17px; color: #000; text-align: left;">VENTA TOTAL :</td>
        ...
        <table align="center" style="width:330px; padding:0 5px;">
            <thead>
                <tr>
                    <th colspan="2" style="font-size: 21px; color: #000; padding-bottom: 5px; text-align: center; ">DETALLES DE PAGO</th>
                </tr>
            </thead>
            <tbody>
            <?php  
        ...
        <table align="center" style="width:330px; padding:0 5px; margin-bottom: 60px;">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2" style="font-size: 17px; color: #000; text-align: left; border-bottom: 1px solid #000; border-bottom-style: dashed;">MONTO AL CIERRE :</td>
                ...
                <tr>
                    <td colspan="3" style="font-size: 17px; color: #000; text-align: left;">IMPRESIÓN :<?php echo date('Y-m-d H:i'); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <table align="center" style="width:330px; padding:0 5px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size: 17px; color: #000; text-align: right; border-top: 1px solid #000;">FIRMA CAJERO</td>
                </tr>
            </tbody>
        </table>
    </div>
