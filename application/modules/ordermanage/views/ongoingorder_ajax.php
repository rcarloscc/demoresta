                                    ...
                                    <div class="col-sm-4 col-md-3 col-xs-6 col-xlg-2">
									   ...
									   foreach($margeinfo as $mergeord){
                                        ...
                                        <p class="m-0">
                                         ...
                                         <?php 
                                          ...
                                          <div>
                                          <a href="javascript:;" onclick="duemergeorder(<?php echo $onprocess->order_id;?>,'<?php echo $onprocess->marge_order_id;?>')" class="btn btn-xs btn-success btn-sm mr-1">
                                            ...
                                            <?php }?>
                                            <a href="javascript:;" class="btn btn-xs btn-success btn-sm mr-1 due_mergeprint" data-toggle="tooltip" data-placement="left" title="" data-url="<?php echo base_url("ordermanage/order/checkprintdue/".$onprocess->marge_order_id) ?>" data-original-title="PRECUENTA">PRECUENTA</a>
                                          </div>
                                      ...
                                      <div class="hero-widget well well-sm height-auto">
                                          ...
                                          <label class="text-muted">
                                            ...
                                            <?php
												if($onprocess->tablename == "" ){
                                                  	echo "<strong style='font-size:45px;color:black'>DOMICILIO";
                                                }else{
                                                	echo "<strong style='font-size:45px;color:black'>". $onprocess->tablename;
                                                }
                                              ?>
                                            </strong></label>
                                          <?php if($this->permission->method('ordermanage','update')->access() && $onprocess->splitpay_status ==0):?>
                                          <div class="display-flex align-items-center" style="position: absolute;top: 60px;">
                                          <div class=""><a href="javascript:;" onclick="editposorder(<?php echo $onprocess->order_id;?>,1)" class="btn btn-xs btn-success btn-sm mr-1 pdmr" data-toggle="tooltip" data-placement="left" title="" data-original-title="ACTUALIZAR ORDEN" id="table-<?php echo $onprocess->order_id;?>">ACTUALIZAR</a></div>
                                        ...
                                        <p class="m-0">
                                         ...
                                         <p class="m-0">
                                          <label class="text-muted"><?php echo 'Cliente';?>:<?php echo $onprocess->customer_name;' '.$onprocess->last_name;?></label>
                                        </p>
                                         <?php 
                                          $diff=0;
                                          ...
                                          <div>
                                           ...
                                           <a href="javascript:;" onclick="showsplitmodal(<?php echo $onprocess->order_id;?>)" class="btn btn-xs btn-success btn-sm mr-1"><?php echo display('split');?></a>
                                            ...
                                            <a href="javascript:;" data-id="<?php echo $onprocess->order_id;?>" class="btn btn-xs btn-danger btn-sm mr-1 cancelorder" data-toggle="tooltip" data-placement="left" title="" data-original-title="Cancel Order"><i class="fa fa-trash-o"></i></a>&nbsp;
                                            <?php }?>
                                            &nbsp;<a href="javascript:;" class="btn btn-xs btn-success btn-sm mr-1 due_print" data-toggle="tooltip" data-placement="left" title="" data-url="<?php echo base_url("ordermanage/order/dueinvoice/".$onprocess->order_id) ?>" data-original-title="PRECUENTA">PRECUENTA</a>
                                            <?php }
                                            else{ ?>
                                               <a href="javascript:;" onclick="showsplitmodal(<?php echo $onprocess->order_id;?>)" class="btn btn-xs btn-success btn-sm mr-1"><?php echo display('split');?></a>
                                               <br><br>
