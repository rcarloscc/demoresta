    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel">
            <fieldset class="border p-2">
                <legend  class="w-auto"><?php echo "ACTUALIZAR ORDEN" ?></legend>
            </fieldset>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $itemsingleprice;?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </td>
                                              	...
                                              	<td class="text-right">
                                                    <?php if ( $this->session->userdata("id")  == 211 || $this->session->userdata("id")  == 171 ) { ?>
                                                    ...
                                                    <span id="productionsetting-update-<?php echo $item->menu_id.'-'.$item->varientid ?>"><?php echo number_format($item->menuqty,3);?> </span>
                                              	...
                                              	<td class="text-right"><?php if($orderinfo->order_status!=4){?>
                                                  	<?php if ( $this->session->userdata("id")  == 211 || $this->session->userdata("id")  == 171 ) { ?>
                                                        <a class="btn btn-danger btn-sm btnrightalign" onclick="deletecart(<?php echo $item->row_id;?>,<?php echo $item->order_id;?>,<?php echo $item->menu_id?>,<?php echo $item->varientid?>,<?php echo $item->menuqty;?>)"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                    <?php } ?>
                                                  <?php } ?></td>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="col-sm-12">
                            ...
                            <input type="button" id="update_order_confirm" onclick="postupdateorder_ajax()" class="btn btn-success btn-large cusbtn" name="add-payment" value="ACTUALIZAR ORDEN">
                        </div>
                    </div>
