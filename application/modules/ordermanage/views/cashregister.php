<div class="modal-header"><h3 class="m-0 p-0">Abrir Caja( <?php echo date('d M, Y H:i')?> ) </h3></div>
              ...
              <div class="panel-body">                
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                      <textarea id="OpeningNote" class="form-control" name="OpeningNote" cols="30" rows="3" placeholder="Nota de Inicio"></textarea>
                    </div>
                  </div>
                  <div class="form-group text-right">
                    <div class="col-sm-11 pr-0">
                      <a href="<?php echo base_url();?>dashboard/home" class="btn btn-success w-md m-b-5"><?php echo "Inicio";?></a>&nbsp;<button type="button" id="openclosecash" class="btn btn-success w-md m-b-5" onclick="opencashregister()"><?php echo display('add_opening_balance');?></button>
                    </div>
                  </div>
                </div>
                </form>
