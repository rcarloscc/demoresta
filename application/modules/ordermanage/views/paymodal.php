            ...
            <div class="panel-body">
              <script>
                 function getNit(){
                   $.ajax({
                     type: "GET",
                     url: "https://app.centraldepago.com/api/fel/getnit/" + $("#nit").val(),
                  ...
                  <div class="col-md-8 row ">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="nit" class="col-form-label pb-2 plw-align">NIT</label>
                                <input type="text" id="nit" name="nit" value="CF" class="form-control" onchange="getNit()" />
                            </div>
                        ...
                        <div class="col-md-4">
							...
							?>
                             ...
                             <div class="form-group">
                                <label for="name" class="col-form-label pb-2 plw-align">Nombre</label>
                                <input type="text" id="name" name="name"class="form-control" value="Consumidor Final" />
                             </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                                <div class="form-group">
                                    <label for="detalle" class="col-form-label pb-2"><?php echo "Detallada";?></label>
                                    <select name="detalle" id="detalle" class="form-control select2-hidden-accessible">
                                            <option value="yes">Con Detalle</option>
                                            <option value="no">Por Consumo</option>
                                    </select>
                                </div>
                        </div>
                    </div>
