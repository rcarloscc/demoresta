...
<div class="page-wrapper">
            ...
            <div class="invoice-head">
			 ...
			 <?php if( !is_null($SERIE) ){ ?>
          	<div class="invoice_address">
                  <?php if($storeinfo->isvatnumshow==1){?><h5 class="item-title">NIT: <?php echo $storeinfo->vattinno;?></h5><?php } ?>    
                  <h5 class="item-title">TELEFONO: <?php echo $storeinfo->phone;?></h5>
                  <h5 class="item-title">FACTURA</h5>
                  <h5 class="item-title">SERIE: <?php echo $SERIE;?></h5>
                  <h5 class="item-title">No.: <?php echo $NUMERO;?></h5>
                  <h5 class="item-title">FECHA: <?php echo date("d/m/Y");?></h5>
                  <h5 class="item-title">AUTORIZACIÓN: <?php echo $AUTORIZACION;?></h5>
                  <h5 class="item-title">NIT: <?php echo $NIT;?></h5>
                  <h5 class="item-title">NOMBRE: <?php echo $NOMBRE_CLIENTE;?></h5>
                  <h5 class="item-title">DIRECCIÓN: CIUDAD</h5>
              </div>
          	<?php } else {	?>
          	<div class="invoice_address">
              <p>Recibo de Pago </p>
		...
		<?php if ($DETALLE == true ) { ?>
			...
			<?php }else{ ?>
  				<div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title">Consumo de Alimentos</h5>
                            </div>
                            <h5><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $billinfo->total_amount;?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
				</div>
  			</div>
            ...
            <div class="invoice_address">
                ...
                <div class="text-center"><br />
                    <h3 class="item-title">Datos del Certificador</h3>
                    <p class="item-title" style="font-size:10px!important">CERTIFICADOR:DIGIFACT SERVICIOS, SOCIEDAD ANONIMA<br />
					<br />NIT: 77454820
                    <br />FECHA DE CERTIFICACIÓN: <?php echo $FECHA_EMISION ?></p>
                </div>
                <div class="text-center">
                    <img src="https://felgttestaws.digifact.com.gt/QRService/api/QR?data=https://felpub.c.sat.gob.gt/verificador-web/publico/vistas/verificacionDte.jsf?tipo=autorizacion|numero=<?php echo $AUTORIZACION; ?>|emisor=<?php echo $storeinfo->vattinno;?>|receptor=<?php echo $NIT;?>|monto=<?php echo $customepaid ?>&size=100x100">
                </div>
                <?php } ?>
            <div class="invoice_address">
                <div class="row-data">
                ...
                <div class="text-center">
                    <p class="mt-10"><?php echo $DTE_LEYENDA;?></p>
                    <h3 class="mt-10">Gracias</h3>
                    <p class="b_top">Desarrollado por <b>www.30y.tech</b></p>
                </div>
            </div>
            </div>
        </div>
