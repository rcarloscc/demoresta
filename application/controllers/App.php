  ...
  public function addLebel() {
	...
	public function printinvoice(){
		...
		$output['orderinfo'][$o]['tableName']=''; 
			...
			$output['orderinfo'][$o]['powerby']=display('powerbypo');
		 $o++;
		}
		return $this->respondWithSuccess('Printing information.', $output);
	...
	public function checkpurchasekey(){
		...
		curl_setopt_array($curl, array(
		  CURLOPT_URL => 'https://store.proyecto-ok.com/class.api.php?domain='.$domain.'&product_key='.$producrtkey.'&purchase_key='.$purchasekey.'',
